    ...
    return (
      <Box sx={{ minHeight: '100vh' }}>
        ...
        <Container sx={{ py: 20, textAlign: 'center' }}>
          <Typography variant="h4" sx={{ color: '#888' }}>خدمت مورد نظر یافت نشد</Typography>
          <Button onClick={() => navigate('/services')} sx={{ mt: 3 }}>بازگشت به خدمات</Button>
        </Container>
        <Footer />
      </Box>
    )
            ...
            <FadeIn>
              <Paper elevation={0} sx={{ p: 4, borderRadius: 4, mb: 4,
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
                  ...
                  <Typography variant="h5" sx={{ fontWeight: 700 }}>این اسکن چیست؟</Typography>
                </Box>
            ...
            <Box sx={{ position: 'sticky', top: 100 }}>
              <FadeIn delay={0.2}>
                ...
                <Paper elevation={0} sx={{ p: 3, borderRadius: 4, mb: 3,
                  ...
                  {[
                    { label: 'مدت زمان', value: service.duration, icon: '⏱️' },
                    { label: 'دسته‌بندی', value: service.category, icon: '🏷️' },
                    { label: 'ماده رادیواکتیو', value: service.tracer, icon: '⚗️' },
                    { label: 'پرتوگیری', value: service.radiation, icon: '☢️' },
                    { label: 'نتیجه', value: service.resultTime, icon: '📋' },
                  ].map((item, i) => (
                ...
                <Paper elevation={0} sx={{ p: 3, borderRadius: 4,
                  ...
                  <Typography sx={{ fontSize: '0.9rem', opacity: 0.85, mb: 2.5 }}>
                    برای رزرو وقت با ما تماس بگیرید
                  </Typography>
